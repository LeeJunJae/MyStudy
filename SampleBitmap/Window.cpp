...
void Window::CenterWindow()
{
	...
	int x = (iScreenWidth - (rtWindow.right - rtWindow.left)) / 2;
	int y = (iScreenHegiht - (rtWindow.bottom - rtWindow.top)) / 2;
	MoveWindow(m_hWnd, x, y, rtWindow.right, rtWindow.bottom, true);
}
bool Window::Run()
{
